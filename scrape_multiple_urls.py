...
def getURLs():
    ...
    savedUserInput = [] #Using a list to allow multiple URLs to be scraped at once
    userInput = None
    ...
    while savedUserInput: #Once at least one URL has been entered, ask if the user's done or wants to scrape more URLs
